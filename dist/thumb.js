...
export function thumbPath(hash, ext = ".png") {
 ...
 */
export async function findThumbnail(hash) {
 ...
 */
export async function ensureThumbnail(hash, options) {
